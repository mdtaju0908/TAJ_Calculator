  ...
  return (
    <div className="p-8 h-full flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-2xl bg-card border border-border rounded-2xl shadow-xl p-6 space-y-6">
        <div>
          <label className="block text-sm font-medium text-muted-foreground mb-2">Expression (in terms of x)</label>
          <input 
            type="text" 
            value={expression}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <button onClick={handleSolve} className="bg-primary text-primary-foreground py-2 rounded-lg font-medium hover:bg-primary/90">
            Evaluate
          </button>
          <button onClick={handleSimplify} className="bg-accent text-accent-foreground py-2 rounded-lg font-medium hover:bg-accent/80">
            Simplify
          </button>
          <button onClick={handleDerivative} className="bg-secondary text-secondary-foreground border border-border py-2 rounded-lg font-medium hover:bg-muted">
            Derivative (d/dx)
          </button>
          <button onClick={handleIntegrate} className="bg-secondary text-secondary-foreground border border-border py-2 rounded-lg font-medium hover:bg-muted">
            Integrate (∫dx)
          </button>
        </div>
