  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950`}>
        <Sidebar />
        <main className="relative flex-1 min-h-screen overflow-y-auto bg-gradient-to-br from-white via-slate-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
          <BackgroundBubbles />
